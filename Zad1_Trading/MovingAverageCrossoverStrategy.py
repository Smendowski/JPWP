...
class Macs:
	...
	def __init__(self, short_window, long_window):
		...
		self.positions = []
		# ZADANIE 1 <--------------------------------------------
		# Dodanie listy przchowującej portfolio
		self.portfolio = []
	...
	# ZADANIE 1 
	 def update_portfolio(self, money):
		# Aktualizacja listy czyli append money
	...
	def raport(self, symbol):
		...
		# ZADANIE 1 <--------------------------------------------
		# Do ramki danych trzeba dodać jeszcze self.portfolio
		...
		# ZADANIE 1 <--------------------------------------------
		axis2 = fig.add_subplot(212, ylabel='Portfolio')
		df['Portfolio'].plot(ax=axis2, color='g', lw=2.)
		plt.title('Portfolio - Zadanie1')

                ...
                for (Element elem : allA) {
                    ...
                    if (elem.text().toLowerCase().contains(phrase.toLowerCase())) {
                        ...
                        if (elem.attr("href").startsWith("/")) {
                            ...
                            site.append("<div class = 'wrapper'><a href='").append(url)
                                    .append(elem.attr("href"))
                                    .append("<h2>")
                                    .append(elem.text())
                                    .append("</h2></a></div>");
                        } else {
                            ...
                            site.append("<div class = 'wrapper'><a href='").append(elem.attr("href"))
                                    .append("<h2>")
                                    .append(elem.text())
                                    .append("</h2></a></div>");
                        }
                ...
                for (Element elem : allA) {
                    ...
                    if (elem.text().toLowerCase().contains(("koronawirus").toLowerCase())) {
                        if (elem.attr("href").startsWith("/")) {
                            ...
                            newsletter.append("\n\nZe strony: ").append(elem.text())
                                    .append(url) // URL bo strona zawiera adresowanie względne
                                    .append(elem.attr("href"));
                        } else {

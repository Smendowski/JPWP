        ...
        try{
            for (String url: addresses) {
                ...
                if (url.equals("https://kwejk.pl")) {
                    ...
                    for (Element img : allImg.subList(0, Math.min(2 * amount, allImg.size()))) {
                        site.append("<div class = 'wrapper'><img src='")
                                .append(img.attr("src"))
                                .append("'></div>");
                    }
                    ...
                    // Sublista od elementu 2 dzięki czemu pominiemy dwa peirwsze obrazki.
                    for (Element img : allImg.subList(2, Math.min(2 + amount, allImg.size()))) {
                        site.append("<div class = 'wrapper'><img src='")
                                .append(img.attr("src"));
                                site.append("'></div>");
                    }
